...
export default ItemDropdown = ({ selected, items, onSelect, buttonClassName = '', menuClassName = '', itemClassName = '' }) => {
  ...
  return (
    <div className={`item-dropdown ${itemClassName}`} onBlur={handleBlur}>
