...
export const TaxInfoFormSection = ({ updateField, userInfo }) => {
  ...
  const handleCheckbox = (e) => {
    ...
    if (!checked) {
      ...
      updateField(FORM_FIELDS.REPORTED_ALL_INCOME)({ target: { value: true } })
    }
  }
              ...
              <div className="tax-info-body">
                ...
                <div>
                  ...
                  <label className="remember-checkbox-container tax-info-body-item">
                    ...
                    <input className="login-checkbox-input" onChange={handleCheckbox} checked={userInfo[FORM_FIELDS.REPORTED_ALL_INCOME]} type="checkbox" required />
                  </label>
                  <Flyout
                    open={flyoutOpen}
                    onClose={() => setFlyoutOpen(false)}
                    buttons={[
                      { text: "I have NOT received a Notice from the IRS", className: "ok-btn", onClick: () => updateField(FORM_FIELDS.REPORTED_ALL_INCOME)({ target: { value: true } }) },
                      { text: "I have received a Notice from the IRS", className: "inverted", onClick: () => updateField(FORM_FIELDS.REPORTED_ALL_INCOME)({ target: { value: false } }) },
                    ]}
